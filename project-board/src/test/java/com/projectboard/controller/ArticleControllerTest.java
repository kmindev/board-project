...
class ArticleControllerTest {
    ...
    @Test
    void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsArticleView() throws Exception {
        // Given
    ...
    @Test
    void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnsArticleView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
