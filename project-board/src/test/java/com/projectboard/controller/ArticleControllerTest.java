...
import com.projectboard.request.ArticleRequest;
import com.projectboard.response.ArticleResponse;
...
class ArticleControllerTest {
    ...
    public void givenNothing_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        ...
        mvc.perform(get("/articles/" + articleId))
                ...
                .andExpect(model().attributeExists("article")) // 데이터(속성)가 있는지만 검사
    ...
    @Test
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsArticleView() throws Exception {
        // Given
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnsArticleView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
        ...
        mvc.perform(
                ...
                .andExpect(view().name("articles/search-hashtag"))
                .andExpect(model().attribute("articles", Page.empty()))
                .andExpect(model().attribute("hashtags", hashtag))
                .andExpect(model().attributeExists("paginationBarNumbers"))
                .andExpect(model().attribute("searchType", SearchType.HASHTAG));
