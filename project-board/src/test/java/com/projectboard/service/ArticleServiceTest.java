...
class ArticleServiceTest {
    ...
    void givenArticleId_whenSearchingArticle_thenReturnsArticle() {
        ...
        // When
        ArticleDto article = sut.searchArticle(1L); // 제목, 본문, ID, 닉네임, 해시테크
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        /**
         * 실제 데이터베이스에 저장되어있는지는 확인하지 않는다.
         * 메서드 호출 정도만 테스트로 확인한다.
         */
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "kkm", "title", "content", "#java"));
